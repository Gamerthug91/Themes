    ...
    [ // Map Definition and FuMS configuration
       ...
       "testpath",                 // MySQL support testing
		true,				//Enable AdminControls! See Docs\AdminControls.txt
         3   //minimum Server FPS. Below this FPS FuMS will not load new missions. 
    ],
    [  // Exclusion Areas
  ...
  ["StaticSpawns",-1], // creates 10 Dayz style Helo crashes at random locations.
   ...
   ["Captive", -1], // Mission in which 7 hostages must be rescued from the humans within 30minutes while fending off paradropped reinforcemnets.
	...
	[ // Soldier Defaults
		...
		[
		.2, // aimingAccuracy .05 : target lead, bullet drop, recoil
		.6,	// aimingShake .9 : how steady AI can hold a weapon
		.6,	// aimingSpeed .1 : how quick AI can rotate and stabilize its aim and shoot.
		.6,	// spotDistance .5 : affects ability to spot visually and audibly and the accuracy of the information
		.6,	// spotTime .5 : affects how quick AI reacts to death, damage or observing an enemy.
		1,	// courage .1 : affects unit's subordinates morale
		1,	// reloadSpeed .5 :affects delay between weapon switching and reloading
		1	// commanding .5 : how quickly recognized targets are shared with the AI's group.
		],
